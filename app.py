...
st.markdown("""
This application detects your skin tone in real-time and provides the closest matching 
skin tone name and hex color code. Simply allow access to your webcam and position 
...
if start_button:
    ...
    if not cap.isOpened():
        ...
        while cap.isOpened() and not stop_button:
            ...
            if face_landmarks:
                ...
                if skin_region.size > 0:
                    ...
                    # Display results
                    skin_tone_name.markdown(f"**Name:** {tone_name}")
                    hex_code.markdown(f"**Hex Code:** {hex_color}")
                    ...
                    cv2.rectangle(frame, (10, 10), (50, 50), dominant_color, -1)
        ...
        if current_hex and current_tone_name:
            ...
            cv2.rectangle(result_img, (0, 0), (400, 200), 
                          (int(current_hex[5:7], 16), 
                           int(current_hex[3:5], 16), 
                           int(current_hex[1:3], 16)), -1)
            ...
            csv_data = pd.DataFrame({
                ...
                'RGB Value': [f"({int(current_hex[1:3], 16)}, {int(current_hex[3:5], 16)}, {int(current_hex[5:7], 16)})"]
            })
            ...
            st.warning("No skin tone was detected. Please try again with better lighting and face positioning.")
